...
// SetValue stores value under key in a derived context, mirroring the semantics
// of gin.Context.Set.
...
// GetValue retrieves the value stored under key, mirroring gin.Context.Get.
