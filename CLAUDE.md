...
- **Regular User** = end-user (PART 34, implemented)
...
19. Use non-conforming IDEA.md → Migrate first (3 required sections)
...
## File Locations
- Config: `/etc/casapps/wthr/server.yml`
- Data: `/var/lib/casapps/wthr/`
- Logs: `/var/log/casapps/wthr/`
- Source: `src/`
- Docker: `docker/`
